...
- [Zona prohibida, p. ej. no tocar `src/legacy/`, está congelada.] - [Regla de seguridad, p. ej. no subir archivos `.env*` al
  repositorio.]
...
- Una tarea a la vez; al terminar, dime qué cambiaste para que lo
  revise. - Si no estás seguro al 80%, pregunta. No inventes.
