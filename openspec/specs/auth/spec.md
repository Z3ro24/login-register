...
Provide standard endpoints to manage User authentication sessions (sign-in, token refresh, and sign-out) with JWT security and role-based access control (RBAC).
## Requirements
